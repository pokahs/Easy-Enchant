...
public class AutoEnchanter {
        ...
        public AutoEnchanter(List<Instruction> instructions, int packetTickDelay, boolean allowRenaming, boolean instant) {
        ...
        public AutoEnchanter(Instruction instruction, int packetTickDelay, boolean allowRenaming, boolean instant, boolean isLastInstruction) {
            this(List.of(instruction), packetTickDelay, allowRenaming, instant);
            this.isStepMode = true;
            this.isLastStep = isLastInstruction;
        }
        ...
        public TickStatus tick() {
            ...
            switch(currentAction) {
                case INPUT_LEFT_ITEM:
                    ...
                    isLastStep = isStepMode ? isLastStep : isLastStep || !instructions.hasNext();
                ...
                case PICKUP_OUTPUT_ITEM:
                    ...
                    if (isSlotOccupied(OUTPUT_SLOT)) {
                        ...
                        if (allowRenaming && isLastStep) return TickStatus.FULLY_DONE; // Stop here to allow renaming
                ...
                case PLACE_OUTPUT_ITEM:
                    ...
                    if (isLastStep) return TickStatus.FULLY_DONE;
        ...
        private void clickSlot(int slotId, SlotActionType actionType) {
            ...
            client.interactionManager.clickSlot(h.syncId, slotId, 0, actionType, client.player);
        }

        private boolean isSlotOccupied(int slotId) {
            MinecraftClient client = MinecraftClient.getInstance();
            var h = client.player.currentScreenHandler;
            ItemStack stack = h.getSlot(slotId).getStack();
